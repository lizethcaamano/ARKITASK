...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input value="{{$grupo->codigo}}" name="codigo"  type="text" placeholder="" class="form-control input-md" maxlength="15">
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input value="{{$grupo->inicio}}" name="inicio"  type="date" placeholder="" class="form-control input-md">
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input value="{{$grupo->desactivacion}}" name="desactivacion"  type="date" placeholder="" class="form-control input-md" >
